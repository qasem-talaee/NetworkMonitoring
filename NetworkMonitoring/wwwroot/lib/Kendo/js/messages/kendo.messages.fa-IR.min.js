!(function (e) {
    ...
    (e = window.kendo.jQuery),
        kendo.ui.FlatColorPicker && (kendo.ui.FlatColorPicker.prototype.options.messages = e.extend(!0, kendo.ui.FlatColorPicker.prototype.options.messages, { apply: "تایید", cancel: "انصراف" })),
        kendo.ui.ColorPicker && (kendo.ui.ColorPicker.prototype.options.messages = e.extend(!0, kendo.ui.ColorPicker.prototype.options.messages, { apply: "تایید", cancel: "انصراف" })),
        kendo.ui.ColumnMenu &&
        ...
        kendo.ui.FilterCell &&
        (kendo.ui.FilterCell.prototype.options.messages = e.extend(!0, kendo.ui.FilterCell.prototype.options.messages, { isTrue: "درست باشد", isFalse: "درست نباشد", filter: "فیلتر", clear: "پاک کردن", operator: "عملگر" })),
        kendo.ui.FilterCell &&
        (kendo.ui.FilterCell.prototype.options.operators = e.extend(!0, kendo.ui.FilterCell.prototype.options.operators, {
            string: { eq: "برابر باشد با", neq: "برابر نباشد با", startswith: "شروع شود با", contains: "شامل باشد", doesnotcontain: "شامل نباشد", endswith: "پایان یابد با" },
            number: { eq: "برابر باشد با", neq: "برابر نباشد با", gte: "برابر یا بزرگتر باشد از", gt: "بزرگتر باشد از", lte: "کمتر و یا برابر باشد با", lt: "کمتر باشد از" },
            date: { eq: "برابر باشد با", neq: "برابر نباشد با", gte: "بعد از یا هم زمان باشد با", gt: "بعد از", lte: "قبل از یا هم زمان باشد با", lt: "قبل از" },
        ...
        kendo.ui.FilterMultiCheck && (kendo.ui.FilterMultiCheck.prototype.options.messages = e.extend(!0, kendo.ui.FilterMultiCheck.prototype.options.messages, { checkAll: "انتخاب همه", clear: "پاک کردن", filter: "فیلتر" })),
        kendo.ui.Gantt &&
        (kendo.ui.Gantt.prototype.options.messages = e.extend(!0, kendo.ui.Gantt.prototype.options.messages, {
            actions: { addChild: "اضافه کردن فرزند", append: "اضافه کردن کار", insertAfter: "اضافه کن زیر", insertBefore: "اضافه کن بالای", pdf: "گرفتن خروجی PDF" },
            cancel: "انصراف",
            ...
            save: "ذخیره",
            views: { day: "روز", end: "پایان", month: "ماه", start: "شروع", week: "هفته", year: "سال" },
        })),
        kendo.ui.Grid &&
        (kendo.ui.Grid.prototype.options.messages = e.extend(!0, kendo.ui.Grid.prototype.options.messages, {
            commands: { search: "جستجو", cancel: "انصراف", canceledit: "انصراف", create: "اضافه کردن ردیف جدید", destroy: "حذف", edit: "ویرایش", excel: "خروجی Excel", pdf: "خروجی PDF", save: "ذخیره", select: "انتخاب", update: "ذخیره" },
            editable: { cancelDelete: "انصراف", confirmation: "آیا از حذف این ردیف مطمئنید؟", confirmDelete: "حذف" },
            noRecords: "اطلاعاتی وجود ندارد",
            
        })),
        kendo.ui.Groupable && (kendo.ui.Groupable.prototype.options.messages = e.extend(!0, kendo.ui.Groupable.prototype.options.messages, { empty: "برای گروه بندی بر اساس یک ستون، عنوان ستون را به اینجا بکشید" })),
        kendo.ui.NumericTextBox && (kendo.ui.NumericTextBox.prototype.options = e.extend(!0, kendo.ui.NumericTextBox.prototype.options, { upArrowText: "اضافه کردن", downArrowText: "کم کردن" })),
        kendo.ui.Pager &&
        ...
        (kendo.ui.PivotFieldMenu.prototype.options.messages = e.extend(!0, kendo.ui.PivotFieldMenu.prototype.options.messages, {
            ...
            ok: "Ok",
            cancel: "Cancel",
            operators: { contains: "Contains", doesnotcontain: "Does not contain", startswith: "Starts with", endswith: "Ends with", eq: "Is equal to", neq: "Is not equal to" },
        })),
        ...
        (kendo.ui.Scheduler.prototype.options.messages = e.extend(!0, kendo.ui.Scheduler.prototype.options.messages, {
            ...
            editable: { confirmation: "Are you sure you want to delete this event?" },
        ...
        kendo.ui.Slider && (kendo.ui.Slider.prototype.options = e.extend(!0, kendo.ui.Slider.prototype.options, { increaseButtonTitle: "افزایش", decreaseButtonTitle: "کاهش" })),
        kendo.ui.TreeList &&
        (kendo.ui.TreeList.prototype.options.messages = e.extend(!0, kendo.ui.TreeList.prototype.options.messages, {
            ...
            retry: "تلاش مجدد",
            commands: { edit: "ویرایش", update: "ذخیره", canceledit: "انصراف", create: "درج ردیف جدید", createchild: "درج گره جدید", destroy: "حذف", excel: "خروجی Excel", pdf: "خروجی PDF" },
        })),
        kendo.ui.TreeView && (kendo.ui.TreeView.prototype.options.messages = e.extend(!0, kendo.ui.TreeView.prototype.options.messages, { loading: "در حال بارگزاری...", requestFailed: "شکست در انجام درخواست.", retry: "تلاش مجدد" })),
        kendo.ui.Upload &&
